<?php
  ...
  // il est destiné à être utilisé via un include et un appel de la fonction MAJ(dos, racine) où dos est le dossier du livre ou de l'exercice
  //
